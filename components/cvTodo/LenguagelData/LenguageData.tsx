...
import styles from './LenguageData.module.css'
import InputsId from '@/components/inputsID/Inputs';

const LenguageData = (props: any) => {
    ...
    return (
        <div >
            <h2 className={styles.titles}>Lenguge</h2>
            {edit ? (
                                ...
                                {itemsData?.map((item: any) => (
                                    <div key={item.id} className={styles.card}>
                                        ...
                                        <div className={styles.cardItem}>
                                            <span className={styles.cardLabel}>Lenguage: </span>
                                        ...
                                        <tr key={index}>
                                            {
                                                ...
                                                (
                                                    Object.entries(item.itemSection).map(([key, value]: [string, any], index: number) => (
                                                        (value !== '' && key !== 'detail_atribute' && key !== 'information'
                                                            && key !== 'information'
                                                            && key !== 'sectionId'
                                                            && key !== 'position'
                                                            && key !== 'createdAt'
